if (('customElements' in self) && customElements.get('network-status') === undefined) {
	customElements.define('network-status', class HTMLNetworkStatusElement extends HTMLElement {
		constructor() {
			super();
