 ...
 */
CustomElement.register('leaflet-map', class HTMLLeafletMapElement extends HTMLElement {
	constructor({
		longitude    = NaN,
		latitude     = NaN,
		zoom         = NaN,
		...
		Promise.resolve().then(async () => {
			const resp = await fetch(new URL('./components/leaflet/map.html', CustomElement.base));
