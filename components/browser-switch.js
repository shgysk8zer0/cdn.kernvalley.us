if (('customElements' in self) && customElements.get('browser-switch') === undefined) {
	customElements.define('browser-switch', class HTMLBrowserSwitchElement extends HTMLElement {
		constructor() {
			super();
